...
class TestZoneProgressionLogic:
    ...
    def test_processing_status_transitions(self):
        ...
        valid_transitions = {
            ProcessingStatus.PENDING: [ProcessingStatus.IN_PROGRESS, ProcessingStatus.SKIPPED],
        ...
        assert ProcessingStatus.IN_PROGRESS in valid_transitions[ProcessingStatus.PENDING]
        assert ProcessingStatus.COMPLETED in valid_transitions[ProcessingStatus.IN_PROGRESS]
