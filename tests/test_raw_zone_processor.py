...
async def test_record_processing():
    ...
    record = RawDataRecord(
        external_id="process_test_1", source="action_network", raw_data=test_data
    )
    ...
    record_dict = RawDataRecord(
        external_id="process_test_2", source="test", raw_data=dict_data
    )
    ...
    record_no_id = RawDataRecord(
        source="test", raw_data={"game_id": "no_id_test", "data": "test"}
    )
...
async def test_table_name_determination():
    ...
    an_game_record = RawDataRecord(
        external_id="an_game", source="action_network", data_type="game"
    )
    ...
    an_odds_record = RawDataRecord(
        external_id="an_odds", source="action_network", data_type="odds"
    )
    ...
    # Test SBD data
    sbd_record = RawDataRecord(external_id="sbd_test", source="sbd")
    ...
    # Test VSIN data
    vsin_record = RawDataRecord(external_id="vsin_test", source="vsin")
    ...
    moneyline_record = RawDataRecord(
        external_id="ml_test", source="generic", bet_type="moneyline"
    )
    ...
    spread_record = RawDataRecord(
        external_id="spread_test", source="generic", bet_type="spread"
    )
    ...
    unknown_record = RawDataRecord(external_id="unknown_test", source="unknown_source")
...
async def test_record_validation():
    ...
    valid_record = DataRecord(
        external_id="valid_test", source="test_source", raw_data={"test": "data"}
    )
    ...
    valid_record_no_id = DataRecord(source="test_source", raw_data={"test": "data"})
    ...
    empty_data_record = DataRecord(
        external_id="empty_data_test", source="test_source", raw_data={}
    )
...
async def test_batch_processing_with_mocks():
    ...
    with (
        patch.object(RawZoneProcessor, "get_connection") as mock_get_conn,
