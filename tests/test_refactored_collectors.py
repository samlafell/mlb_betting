...
class TestValidationAndNormalization:
    ...
    def test_sbd_collector_validation(self):
        ...
        invalid_record = {"game_name": "Yankees @ Red Sox"}
...
class TestMigrationHelper:
    ...
    def test_create_collector_config(self):
        ...
        config = create_collector_config(
            DataSource.SBD, base_url="https://test.com", rate_limit_per_minute=30
        )
    ...
    def test_create_collection_request(self):
        ...
        request = create_collection_request(
            DataSource.VSIN, sport="nfl", dry_run=True, sportsbook="dk"
        )
...
class TestIntegrationScenarios:
    ...
    async def test_full_collection_workflow_sbd(self):
        ...
        request = create_collection_request(DataSource.SBD, sport="mlb", dry_run=True)
    ...
    async def test_error_handling_and_recovery(self):
        ...
        request = CollectionRequest(source=DataSource.VSIN, sport="mlb", dry_run=True)
