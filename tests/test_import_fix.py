...
def test_collectors_py_structure():
    ...
    collectors_path = (
        Path(__file__).parent.parent / "src" / "data" / "collection" / "collectors.py"
    )
    ...
    with open(collectors_path) as f:
        content = f.read()
...
def test_init_py_structure():
    ...
    init_path = (
        Path(__file__).parent.parent / "src" / "data" / "collection" / "__init__.py"
    )
...
def test_consolidated_collector_exists():
    ...
    consolidated_path = (
        ...
        / "data"
        / "collection"
        / "consolidated_action_network_collector.py"
    )
