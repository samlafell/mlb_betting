...
def test_zone_progression_validation():
    ...
    from src.data.pipeline.zone_interface import ZoneType, validate_zone_progression
    ...
    assert (
        validate_zone_progression(ZoneType.RAW, ZoneType.CURATED) is False
    )  # Skip staging
    assert (
        validate_zone_progression(ZoneType.STAGING, ZoneType.RAW) is False
    )  # Backward
    assert (
        validate_zone_progression(ZoneType.CURATED, ZoneType.RAW) is False
    )  # Backward
...
def test_get_next_zone():
    ...
    from src.data.pipeline.zone_interface import ZoneType, get_next_zone
...
def test_data_record_structure():
    ...
    from src.data.pipeline.zone_interface import DataRecord, ProcessingStatus
