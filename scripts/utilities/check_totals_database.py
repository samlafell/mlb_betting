...
async def check_totals():
    ...
    print("Parsed Games Analysis (July 8th):")
    ...
    if totals_with_data:
        ...
        game_data = (
            json.loads(totals_with_data["game_data"])
            if isinstance(totals_with_data["game_data"], str)
            else totals_with_data["game_data"]
        )
