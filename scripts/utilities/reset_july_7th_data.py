...
async def collect_july_7th_fresh():
    ...
    async with CollectionOrchestrator() as orchestrator:
        try:
            ...
            print("📥 Phase 1: Scraping July 7th data...")
            await orchestrator.scrape_with_progress(target_date, target_date)

            # Process staging data
            print("⚙️  Phase 2: Processing staging data...")
            await orchestrator.process_staging()

            print("✅ Fresh collection complete!")
...
async def verify_july_7th_results():
    ...
    try:
        ...
        print("  July 7th betting records:")
        total_records = 0
...
async def main():
    ...
    print("🧪 JULY 7TH DATA RESET AND FRESH COLLECTION")
    print("=" * 50)
