                        ...
                        if "window.APP_STATE" in html_content:
                            ...
                            if start != -1:
                                ...
                                if end != -1:
                                    ...
                                    print(
                                        f"JSON Data Length: {len(json_data)} characters"
                                    )
                                        ...
                                        if game_count > 0:
                                            ...
                                            try:
                                                ...
                                                if (
                                                    ...
                                                    sample_game = list(
                                                        app_state["games"].values()
                                                    )[0]
                                                    print(
                                                        f"Sample game: {sample_game.get('away', {}).get('name', 'Unknown')} @ {sample_game.get('home', {}).get('name', 'Unknown')}"
                                                    )
                                            except:
