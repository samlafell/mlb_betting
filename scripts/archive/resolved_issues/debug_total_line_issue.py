...
async def debug_total_line_issue():
    ...
    print(
        f"(over_odds is not None or under_odds is not None): {(over_odds is not None or under_odds is not None)}"
    )
    print(
        f"Full condition: {total_line is not None and (over_odds is not None or under_odds is not None)}"
    )
