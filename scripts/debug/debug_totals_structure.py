                                        ...
                                        if game_rows:
                                            ...
                                            if 'oddsViews' in first_game:
                                                ...
                                                if valid_odds_views:
                                                    ...
                                                    for i, odds_view in enumerate(valid_odds_views[:2]):  # Show first 2
                                                        ...
                                                        print(f"    Current Line Keys: {list(current_line.keys())}")
                                                        print(f"    Opening Line Keys: {list(opening_line.keys())}")
                                                        
                                                        # Check all possible total-related fields
                                                        total_fields = [
                                                            'total', 'totalLine', 'total_line', 'line',
                                                            'overOdds', 'underOdds', 'over_odds', 'under_odds',
                                                            'overTotal', 'underTotal', 'totalValue'
                                                        ]
                                                        
                                                        print(f"    🔍 Current Line Totals Fields:")
                                                        for field in total_fields:
                                                            if field in current_line:
                                                                print(f"      {field}: {current_line[field]}")
                                                        
                                                        print(f"    🔍 Opening Line Totals Fields:")
                                                        for field in total_fields:
                                                            if field in opening_line:
                                                                print(f"      {field}: {opening_line[field]}")
