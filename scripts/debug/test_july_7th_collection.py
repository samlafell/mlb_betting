    ...
    try:
        ...
        async with CollectionOrchestrator(
            ...
            if 'scraping_results' in results:
                ...
                print(f"Scraping Success Rate: {scraping.get('success_rate_percent', 0):.1f}%")
            ...
            if 'storage_results' in results:
                ...
                print(f"Storage Success Rate: {storage.get('success_rate_percent', 0):.1f}%")
    ...
    try:
        ...
        if games:
            ...
            for game in games[:5]:  # Show first 5
                print(f"  ID {game['id']}: {game['away_team']} @ {game['home_team']} (SBR: {game['sportsbookreview_game_id']})")
