                            ...
                            if match:
                                ...
                                try:
                                    ...
                                    if "pageProps" in data["props"]:
                                        ...
                                        print(
                                            f"props keys: {list(data['props'].keys())}"
                                        )
                                    ...
                                    if end != -1:
                                        ...
                                        try:
                                            ...
                                            if "props" in data:
                                                ...
                                                if "pageProps" in data["props"]:
                                                    print(
                                                        "✅ Found pageProps in Next.js data"
                                                    )
                                                    if (
                                                        "oddsTables"
                                                        in data["props"]["pageProps"]
                                                    ):
                                                        print(
                                                            "✅ Found oddsTables in Next.js data"
                                                        )
                                                    else:
                                                        print(
                                                            "❌ No oddsTables in Next.js pageProps"
                                                        )
                                                        print(
                                                            f"Next.js pageProps keys: {list(data['props']['pageProps'].keys())}"
                                                        )
                                                else:
                                                    print(
                                                        "❌ No pageProps in Next.js props"
                                                    )
                                            else:
                                            ...
                                            print(
                                                f"❌ Next.js JSON parsing failed: {e}"
                                            )
