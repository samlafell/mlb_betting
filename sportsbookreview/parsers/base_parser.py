...
class SportsbookReviewBaseParser(ABC):
    ...
    @abstractmethod
    def parse_game_data(
        self, soup: BeautifulSoup, game_url: str
    ) -> EnhancedGame | None:
    ...
    def extract_game_id(self, url: str) -> str | None:
    ...
    def extract_team_names(self, text: str) -> tuple[str | None, str | None]:
        """
    ...
    def parse_american_odds(self, odds_text: str) -> int | None:
        """
    ...
    def parse_percentage(self, pct_text: str) -> float | None:
        """
    ...
    def parse_game_datetime(
        self, date_text: str, time_text: str = None
    ) -> datetime | None:
        """
        ...
        try:
            ...
            self.logger.error(
                f"Error parsing datetime '{date_text}' '{time_text}': {e}"
            )
            return None

    def extract_sportsbook_name(self, element: Tag) -> str | None:
        """
