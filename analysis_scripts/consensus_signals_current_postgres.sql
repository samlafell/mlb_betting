...
SELECT 
    ...
    ROUND((money_pct)::NUMERIC, 1) as money_percentage,
    ROUND((bet_pct)::NUMERIC, 1) as bet_percentage,
    ROUND(((money_pct + bet_pct) / 2)::NUMERIC, 1) as consensus_strength,
    ROUND((ABS(money_pct - bet_pct))::NUMERIC, 1) as alignment_gap,
    CASE 
