    ...
    try:
        ...
        if results:
            ...
            for i, row in enumerate(results, 1):
                source_book, flip_type, bets, wins, win_rate, late_wins, late_win_rate, roi, late_roi, early_strength, late_strength = row
            ...
            if overall_roi >= 10.0:
                ...
                print(f'   🏦 With $1000 bankroll, expect ~${overall_roi*10:.2f} monthly profit')
                ...
                print(f'   🔧 RECOMMENDATION: Consider refining thresholds or increasing sample size')
                print(f'   💰 Expected profit: ${overall_roi:.2f} per $100 wagered')
            else:
            ...
            cross_market_results = [r for r in results if r[1] == 'CROSS_MARKET_CONTRADICTION']
            ...
            if overall_roi > 5:
                ...
                print('   📊 Set minimum confidence thresholds based on signal strength')
            ...
            print('🔧 The debugging showed contradictions exist, so there may be a JOIN issue')
