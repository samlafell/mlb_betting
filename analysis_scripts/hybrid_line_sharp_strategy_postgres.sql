...
SELECT 
    ...
    -- Profit per bet
    ROUND((((wins * 100) - ((total_bets - wins) * 110)) / total_bets)::NUMERIC, 2) as profit_per_bet,
    
    -- Average metrics
    ROUND((avg_line_movement)::NUMERIC, 1) as avg_line_move,
    ROUND((avg_closing_differential)::NUMERIC, 1) as avg_diff,
    ROUND((avg_closing_stake_pct)::NUMERIC, 1) as avg_stake_pct,
