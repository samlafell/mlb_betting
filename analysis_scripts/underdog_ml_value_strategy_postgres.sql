...
SELECT 
    ...
    ROUND((avg_underdog_odds)::NUMERIC, 0) as avg_dog_odds,
    ROUND((avg_home_bet_pct)::NUMERIC, 1) as avg_home_bet_pct,
    ROUND((avg_differential)::NUMERIC, 1) as avg_differential,
