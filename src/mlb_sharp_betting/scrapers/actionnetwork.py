...
class ActionNetworkScraper(JSONScraper):
    ...
    async def scrape_history_url(
        ...
        try:
            self.logger.info(
                "Scraping Action Network history",
                game_id=game_id,
            ...
            self.logger.info(
                "Action Network history scraping completed",
                game_id=game_id,
    ...
    def _process_historical_response(
        ...
        try:
            ...
            self.logger.error(
                "Failed to process historical response", error=str(e), game_id=game_id
            )
            return None
    ...
    async def scrape_multiple_histories(
        ...
        self.logger.info(
            "Scraping multiple Action Network histories", game_count=len(game_data_list)
        )
        ...
        self.logger.info(
            "Completed multiple history scraping",
