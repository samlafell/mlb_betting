...
class SBDScraper(JSONScraper):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        super().__init__(source_name="SBD", **kwargs)
    ...
    def build_url(self, sport: str = "mlb", books: list[str] | None = None) -> str:
        """
        ...
        for game in games:
            try:
                ...
                if not game.get("bettingSplits"):
                    logger.warning(
                        "Game missing bettingSplits field", game_id=game.get("_id")
                    )
                    continue
    ...
    async def scrape(
        self, sport: str = "mlb", books: list[str] | None = None, **kwargs: Any
    ) -> "ScrapingResult":
        """
        ...
        try:
            ...
            logger.info(
                "SBD scraping completed successfully",
