...
class MLBStatsAPIClient:
    ...
    def __init__(self, timeout: int = 30):
        ...
        self.team_id_map = {
            Team.LAA: 108, Team.HOU: 117, Team.OAK: 133, Team.SEA: 136, Team.TEX: 140,
            Team.NYY: 147, Team.BOS: 111, Team.BAL: 110, Team.TB: 139, Team.TOR: 141, Team.CWS: 145,
            Team.CLE: 114, Team.DET: 116, Team.KC: 118, Team.MIN: 142,
            Team.ATL: 144, Team.MIA: 146, Team.NYM: 121, Team.PHI: 143, Team.WSH: 120,
            Team.CHC: 112, Team.CIN: 113, Team.MIL: 158, Team.PIT: 134, Team.STL: 138,
            Team.ARI: 109, Team.COL: 115, Team.LAD: 119, Team.SD: 135, Team.SF: 137
        }
    ...
    async def _get_json(self, url: str, params: Optional[Dict[str, Any]] = None) -> Optional[Dict[str, Any]]:
        ...
        """
        if not self.session:
            raise MLBAPIError("Client session not initialized. Use async context manager.")
        ...
        try:
            ...
            async with self.session.get(url, params=params) as response:
                if response.status == 200:
                    ...
                    logger.warning("MLB API request failed", 
    ...
    async def get_schedule(self, 
                          ...
                          sport_id: int = 1) -> Optional[Dict[str, Any]]:
        """
    ...
    async def get_game_live_feed(self, game_pk: str) -> Optional[Dict[str, Any]]:
        """
    ...
    async def get_game_boxscore(self, game_pk: str) -> Optional[Dict[str, Any]]:
        """
    ...
    async def get_game_linescore(self, game_pk: str) -> Optional[Dict[str, Any]]:
        """
    ...
    async def get_completed_games(self, 
                                 start_date: Union[date, datetime, str],
                                 end_date: Optional[Union[date, datetime, str]] = None) -> List[Dict[str, Any]]:
        """
    ...
    def extract_game_result(self, game_data: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        """
        ...
        try:
            ...
            if not home_team or not away_team:
                logger.warning("Unknown team IDs", 
            ...
            logger.error("Failed to extract game result", error=str(e), game_data=game_data)
            return None
