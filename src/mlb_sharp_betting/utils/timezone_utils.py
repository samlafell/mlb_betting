...
def ensure_est(dt: Union[datetime, None]) -> Optional[datetime]:
    """
...
def ensure_naive(dt: Union[datetime, None]) -> Optional[datetime]:
    """
...
def format_est_time(dt: Union[datetime, None], format_str: str = "%Y-%m-%d %H:%M EST") -> str:
    """
...
def hours_since(dt: Union[datetime, None]) -> float:
    """
...
def display_age(dt: Union[datetime, None]) -> str:
    """
