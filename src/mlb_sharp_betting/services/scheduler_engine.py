...
class SchedulerEngine:
    ...
    def __init__(
        ...
        self.logger.info(
            "SchedulerEngine initialized - modules will be loaded on demand"
        )
    ...
    def _load_core_scheduler(self):
        ...
        return CoreScheduler(
            scheduler_engine=self, mlb_api=self.mlb_api, project_root=self.project_root
        )
    ...
    async def start(self, mode: str = "full") -> None:
        ...
        try:
            ...
            self.logger.info(
                "SchedulerEngine started successfully",
                mode=mode,
    ...
    async def _start_core_scheduling(self):
        ...
        self.scheduler.add_job(
            ...
            trigger=CronTrigger(
                hour=self.daily_setup_hour, minute=0, timezone=self.est
            ),
        ...
        try:
            ...
            if result["success"]:
                ...
                self.engine.metrics.update(
                    "last_hourly_run", datetime.now(timezone.utc)
                )
    ...
    async def _run_entrypoint(self, context: str = "scheduled") -> dict[str, Any]:
        ...
        try:
            ...
            cmd = [
                ...
                "smart-pipeline",
                "--minutes",
                "120",  # Increased from default 60 to 120
...
_scheduler_engine_instance: SchedulerEngine | None = None
