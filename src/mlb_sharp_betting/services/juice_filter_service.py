...
class JuiceFilterService:
    ...
    def should_filter_bet(
        self,
        moneyline_odds: Union[str, Dict, int, float],
        ...
        if recommended_odds < 0 and recommended_odds < self.juice_config.max_juice_threshold:
    ...
    def _parse_moneyline_odds(self, odds: Union[str, Dict, int, float]) -> Optional[Dict[str, float]]:
        ...
        try:
            ...
            if recommended_team == home_team and 'home' in odds_dict:
                ...
                if home_team and recommended_team in home_team and 'home' in odds_dict:
                    return odds_dict['home']
                elif away_team and recommended_team in away_team and 'away' in odds_dict:
                    return odds_dict['away']
    ...
    def get_filter_summary(self) -> Dict[str, Union[bool, int, str]]:
