...
class ValidationGateService:
    ...
    async def check_strategy_gate(self, strategy_name: str, context: str = "unknown") -> ValidationGateResponse:
        ...
        try:
            ...
            validation_result = self.registry.can_generate_recommendations(strategy_name)
            ...
            if validation_result['allowed']:
                ...
                return ValidationGateResponse(
                    ...
                    max_bet_size_multiplier=validation_result.get('max_bet_size_multiplier', 1.0),
                    requires_manual_approval=validation_result.get('requires_manual_approval', False)
                )
                ...
                return ValidationGateResponse(
                    ...
                    allowed=False,
                    reason=reason,
                    requires_validation=validation_result.get('requires_validation', False),
...
# Singleton pattern
_gate_service_instance: Optional[ValidationGateService] = None
