...
class TableRegistry:
    ...
    def get_table(self, logical_name: str) -> str:
        ...
        self.logger.debug(
            "Table name resolved", logical_name=logical_name, actual_name=table_name
        )
        return table_name
    ...
    def add_table(self, logical_name: str, actual_name: str) -> None:
        ...
        self.logger.info(
            "Table mapping added", logical_name=logical_name, actual_name=actual_name
        )
...
_global_registry: TableRegistry | None = None
