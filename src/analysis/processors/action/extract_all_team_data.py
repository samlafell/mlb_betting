...
class ActionNetworkTeamExtractor:
    ...
    def fetch_scoreboard_data(self) -> dict[str, Any]:
        ...
        try:
            ...
            log_info(
                "Successfully fetched scoreboard data",
    ...
    def run(self):
        ...
        print("=" * 50)
        print("📅 Extracting data for July 1, 2025")
        print()
            ...
            for team in team_data:
                ...
                if game_idx not in games_found and game_idx < 3:  # Show first 3 games
                    ...
                    home_team = next(
                        t
                        for t in team_data
                        if t["game_index"] == game_idx and t["team_index"] == 0
                    )
                    away_team = next(
                        t
                        for t in team_data
                        if t["game_index"] == game_idx and t["team_index"] == 1
                    )
