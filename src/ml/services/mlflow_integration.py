...
class MLflowService:
    ...
    def _setup_mlflow(self):
        ...
        try:
            ...
            logger.info(f"  Backend store: {db_config.host}:{db_config.port}/{db_config.database}")
    ...
    def create_experiment(self, name: str, description: str = None, tags: Dict[str, str] = None) -> str:
    ...
    def start_run(self, experiment_id: str, run_name: str = None, tags: Dict[str, str] = None):
    ...
    def get_latest_model(self, experiment_name: str, metric_name: str = "accuracy") -> Optional[Dict[str, Any]]:
    ...
    def sync_with_ml_experiments_table(self, experiment_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            experiment_data = {
                ...
                'status': 'active' if experiment.lifecycle_stage == 'active' else 'archived',
                'lifecycle_stage': experiment.lifecycle_stage,
                'total_runs': len(runs),
                'created_at': datetime.fromtimestamp(experiment.creation_time / 1000),
                'last_updated': datetime.fromtimestamp(experiment.last_update_time / 1000)
            }
