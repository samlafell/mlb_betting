...
class SportsbookResolver:
    ...
    async def resolve_action_network_id(self, action_network_id: int) -> Optional[Tuple[int, str]]:
        """
...
async def get_sportsbook_mapping(db_config: Dict, action_network_id: int) -> Optional[Tuple[int, str]]:
    """
