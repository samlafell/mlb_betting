...
class ActionNetworkHistoryProcessor:
    ...
    async def initialize(self):
        ...
        logger.info("ActionNetworkHistoryProcessor initialized with MLB Stats API integration")
    ...
    async def process_history_data(self, limit: int = 10) -> Dict[str, Any]:
        ...
        """
        logger.info(f"Starting history data processing", 
        ...
        try:
            ...
            for raw_history_record in raw_history_data:
                try:
                    ...
                    logger.error(f"Error processing history record {raw_history_record['id']}: {e}")
                    continue
    ...
    async def _extract_historical_records_from_history(self, raw_history: Dict, conn: asyncpg.Connection) -> List[HistoricalOddsRecord]:
                ...
                for market_type in ['moneyline', 'spread', 'total']:
                    ...
                    for side_data in market_data:
                        ...
                        for hist_entry in history:
                            ...
                            is_current = (hist_odds == current_odds and 
                                        self._safe_decimal(hist_entry.get('value')) == line_value)
                            if is_current:
