...
class Team(str, Enum):
    ...
    def normalize_team_name(cls, name: str) -> Optional['Team']:
        ...
        name_mappings = {
            ...
            "RAYS": "TB", "BLUE JAYS": "TOR", "WHITE SOX": "CWS",
...
class UnifiedGame(UnifiedEntity):
    ...
    game_id: str = Field(
        ...,
        description="Primary game identifier",
        min_length=1,
        max_length=100
    )
    ...
    sbr_game_id: Optional[str] = Field(
        default=None,
        description="SportsbookReview game identifier",
        max_length=100
    )
    
    action_network_game_id: Optional[int] = Field(
        default=None,
    ...
    game_date: date = Field(
        ...,
        description="Game date (EST)"
    )
    
    game_time: Optional[time] = Field(
        default=None,
        description="Game start time (EST)"
    )
    ...
    @classmethod
    def validate_winning_team(cls, v: Optional[Team], info) -> Optional[Team]:
    ...
    def is_completed(self) -> bool:
        ...
        return (
            self.game_status == GameStatus.FINAL and
    ...
    def has_mlb_enrichment(self) -> bool:
        ...
        return bool(
            ...
            (self.venue_info or self.weather_data or 
             self.pitcher_matchup or self.game_context)
        )
