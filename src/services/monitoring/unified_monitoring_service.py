...
class UnifiedMonitoringService:
    ...
    def _import_legacy_services(self):
        ...
        try:
            ...
            logger.info(
                "Legacy monitoring services migration completed - using unified implementation"
            )
    ...
    async def _check_database_health(self) -> dict[str, Any]:
        ...
        try:
            ...
            if (
                pool_info.get("active_connections", 0)
                > pool_info.get("max_connections", 10) * 0.8
            ):
                status = HealthStatus.WARNING
            ...
            return {
                "status": status,
                "message": message,
                "metadata": {"query_time": query_time, "pool_info": pool_info},
            }
            ...
            for source in data_sources:
                try:
                    ...
                    if source_status["status"] == HealthStatus.CRITICAL:
                        ...
                        source_status["status"] == HealthStatus.WARNING
    ...
    async def _check_system_resources(self) -> dict[str, Any]:
        ...
        try:
            ...
            message = (
                "; ".join(messages) if messages else "System resources are healthy"
            )
