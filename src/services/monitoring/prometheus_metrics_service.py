...
class PrometheusMetricsService:
    ...
    def _init_pipeline_metrics(self):
        ...
        # Pipeline queue and concurrency
    ...
    def record_pipeline_completion(
        ...
        self.sli_pipeline_latency_seconds.labels(
            pipeline_type=pipeline_type
        ).observe(duration)
    ...
    def record_stage_execution(
        ...
        """Record the execution of a pipeline stage."""
    ...
    def record_opportunity_detected(self, strategy: str, confidence_level: str):
        """Record a betting opportunity detection."""
    ...
    def record_recommendation_made(self, strategy: str, outcome: str = "pending"):
        """Record a betting recommendation."""
    ...
    def update_strategy_performance(self, strategy_name: str, score: float):
        ...
        self.strategy_performance_score.labels(strategy_name=strategy_name).set(score)
    ...
    def record_api_call(self, api_name: str, endpoint: str, duration: float, error_code: Optional[str] = None):
