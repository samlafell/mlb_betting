...
class Game:
    def __init__(self, game_id: str, home_team: str, away_team: str, game_datetime: datetime):
        self.game_id = game_id  # A unique identifier for the game (e.g., "PIT@CHC_2025-06-13")
...
class BaseSplit:
    def __init__(self, game_id: str, home_team: str, away_team: str, game_datetime: datetime, 
                 last_updated: datetime, source: str = "SBD", book: str = None, 
                 sharp_action: bool = False, outcome: str = None):
...
class SpreadSplit(BaseSplit):
    def __init__(self, game_id: str, home_team: str, away_team: str, game_datetime: datetime,
                 last_updated: datetime, spread_value: str,
                 home_team_bets: int = None, home_team_bets_percentage: float = None, home_team_stake_percentage: float = None,
                 away_team_bets: int = None, away_team_bets_percentage: float = None, away_team_stake_percentage: float = None,
                 source: str = "SBD", book: str = None, sharp_action: bool = False, outcome: str = None):
        super().__init__(game_id, home_team, away_team, game_datetime, last_updated, source, book, sharp_action, outcome)
    ...
    def __repr__(self):
        return (f"SpreadSplit(Game: {self.away_team} @ {self.home_team}, Spread: {self.spread_value}, "
...
class TotalSplit(BaseSplit):
    def __init__(self, game_id: str, home_team: str, away_team: str, game_datetime: datetime,
                 last_updated: datetime, total_value: str,
                 over_bets: int = None, over_bets_percentage: float = None, over_stake_percentage: float = None,
                 under_bets: int = None, under_bets_percentage: float = None, under_stake_percentage: float = None,
                 source: str = "SBD", book: str = None, sharp_action: bool = False, outcome: str = None):
        super().__init__(game_id, home_team, away_team, game_datetime, last_updated, source, book, sharp_action, outcome)
    ...
    def __repr__(self):
        return (f"TotalSplit(Game: {self.away_team} @ {self.home_team}, Total: {self.total_value}, "
...
class MoneylineSplit(BaseSplit):
    def __init__(self, game_id: str, home_team: str, away_team: str, game_datetime: datetime,
                 last_updated: datetime, moneyline_value: str,
                 home_team_bets: int = None, home_team_bets_percentage: float = None, home_team_stake_percentage: float = None,
                 away_team_bets: int = None, away_team_bets_percentage: float = None, away_team_stake_percentage: float = None,
                 source: str = "SBD", book: str = None, sharp_action: bool = False, outcome: str = None):
        super().__init__(game_id, home_team, away_team, game_datetime, last_updated, source, book, sharp_action, outcome)
    ...
    def __repr__(self):
        return (f"MoneylineSplit(Game: {self.away_team} @ {self.home_team}, ML: {self.moneyline_value}, "
                f"Home: {self.home_team_bets} bets ({self.home_team_bets_percentage}%), "
                f"Away: {self.away_team_bets} bets ({self.away_team_bets_percentage}%), "
                f"Outcome: {self.outcome}, Sharp: {self.sharp_action})")
...
class SplitDetail:
    def __init__(self, bets: int = None, bets_percentage: float = None, stake_percentage: float = None, money: float = None):
        self.bets = bets
...
class Split:
    ...
    def __repr__(self):
        repr_str = (f"Split(Game ID: '{self.game_id}', Source: {self.source.value}, Type: {self.split_type.value}, "
